...
public class AvoidObstaclesData
{
    ...
    public AvoidObstaclesData(float evaluatePriority, bool avoidTerrainOnly, float swimVelocity, float avoidanceDistance, float scanDistance, float avoidanceDuration = 2f, float scanInterval = 1f, float scanRadius = 0f, int avoidanceIterations = 10)
    {
